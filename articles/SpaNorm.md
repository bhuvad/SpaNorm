...
![](SpaNorm_files/figure-html/unnamed-chunk-9-1.png)
...
#> iter:  1, estimating gene-wise dispersion
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  1, log-likelihood: -3192888.330698
#> iter:  1, fitting NB model
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  1, iter:  1, log-likelihood: -3192888.330698
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  1, iter:  2, log-likelihood: -2602759.737492
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  1, iter:  3, log-likelihood: -2480489.457791
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  1, iter:  4, log-likelihood: -2453590.894326
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  1, iter:  5, log-likelihood: -2450616.393063
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  1, iter:  6, log-likelihood: -2450469.710404 (converged)
#> iter:  2, estimating gene-wise dispersion
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  2, log-likelihood: -2449645.830405
#> iter:  2, fitting NB model
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  2, iter:  1, log-likelihood: -2449645.830405
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  2, iter:  2, log-likelihood: -2449645.830405
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  2, iter:  3, log-likelihood: -2449645.830405 (converged)
#> iter:  3, estimating gene-wise dispersion
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  3, log-likelihood: -2449645.830405
#> iter:  3, fitting NB model
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  3, iter:  1, log-likelihood: -2449645.830405
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  3, iter:  2, log-likelihood: -2449645.830405
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
...
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> Hint: To use tensorflow with `py_require()`, call `py_require("tensorflow")` at the start of the R session
#> iter:  3, iter:  3, log-likelihood: -2449645.830405 (converged)
#> iter:  4, log-likelihood: -2449645.830405 (converged)
#> (3/3) Finding SVGs
#> 248 SVGs found (FDR < 0.05)
HumanDLPFC
#> class: SpatialExperiment 
#> dim: 2508 4015 
...
svgs
#>             svg.F         svg.p       svg.fdr
#> SCGB2A2 102.79344  0.000000e+00  0.000000e+00
#> SCGB1D2  56.01454 2.756886e-321 3.457135e-318
#> SAA1     40.31921 1.613374e-237 1.348781e-234
#> MBP      30.06252 2.341541e-178 1.468146e-175
#> MGP      27.18234 4.527605e-161 2.271047e-158
#> TMSB10   26.83072 6.120019e-159 2.558168e-156
#> CARTPT   26.40099 2.495026e-156 8.939321e-154
#> KRT8     21.47909 5.801712e-126 1.818837e-123
#> MT-ATP6  21.36743 2.899249e-125 8.079239e-123
#> MT-CO2   21.32338 5.470948e-125 1.372114e-122
```
...
#> [15] patchwork_1.3.2             ggplot2_4.0.1              
#> [17] SpaNorm_1.5.1              
#> 
#> loaded via a namespace (and not attached):
#>  [1] gridExtra_2.3       rlang_1.1.7         magrittr_2.0.4     
#>  [4] otel_0.2.0          compiler_4.5.2      png_0.1-8          
#>  [7] systemfonts_1.3.1   vctrs_0.6.5         pkgconfig_2.0.3    
#> [10] fastmap_1.2.0       magick_2.9.0        XVector_0.50.0     
#> [13] labeling_0.4.3      rmarkdown_2.30      ggbeeswarm_0.7.3   
#> [16] ragg_1.5.0          xfun_0.55           bluster_1.20.0     
#> [19] cachem_1.1.0        beachmat_2.26.0     jsonlite_2.0.0     
#> [22] DelayedArray_0.36.0 BiocParallel_1.44.0 irlba_2.3.5.1      
#> [25] parallel_4.5.2      cluster_2.1.8.1     tensorflow_2.20.0  
#> [28] R6_2.6.1            bslib_0.9.0         RColorBrewer_1.1-3 
#> [31] limma_3.66.0        reticulate_1.44.1   jquerylib_0.1.4    
#> [34] Rcpp_1.1.0          knitr_1.51          base64enc_0.1-3    
#> [37] FNN_1.1.4.1         Matrix_1.7-4        splines_4.5.2      
#> [40] igraph_2.2.1        tidyselect_1.2.1    abind_1.4-8        
#> [43] yaml_2.3.12         viridis_0.6.5       codetools_0.2-20   
#> [46] lattice_0.22-7      tibble_3.3.0        withr_3.0.2        
#> [49] S7_0.2.1            evaluate_1.0.5      desc_1.4.3         
#> [52] pillar_1.11.1       BiocManager_1.30.27 whisker_0.4.1      
#> [55] scales_1.4.0        BiocStyle_2.38.0    glue_1.8.0         
#> [58] metapod_1.18.0      tools_4.5.2         BiocNeighbors_2.4.0
#> [61] RSpectra_0.16-2     ScaledMatrix_1.18.0 locfit_1.5-9.12    
#> [64] fs_1.6.6            scran_1.38.0        cowplot_1.2.0      
#> [67] grid_4.5.2          edgeR_4.8.2         beeswarm_0.4.0     
#> [70] BiocSingular_1.26.1 vipor_0.4.7         cli_3.6.5          
#> [73] rsvd_1.0.5          textshaping_1.0.4   tfruns_1.5.4       
#> [76] S4Arrays_1.10.1     viridisLite_0.4.2   dplyr_1.1.4        
#> [79] uwot_0.2.4          gtable_0.3.6        sass_0.4.10        
#> [82] digest_0.6.39       SparseArray_1.10.8  ggrepel_0.9.6      
#> [85] dqrng_0.4.1         rjson_0.2.23        htmlwidgets_1.6.4  
#> [88] farver_2.1.2        htmltools_0.5.9     pkgdown_2.2.0      
#> [91] lifecycle_1.0.5     prettydoc_0.4.1     statmod_1.5.1
```
